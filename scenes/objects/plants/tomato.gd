...
var growth_sate: Data_types.GrowthStates = Data_types.GrowthStates.Seed
...
func _process(delta: float) -> void:
	growth_sate = growth_cycle_component.get_current_growth_state()
	sprite_2d.frame = growth_sate + start_tomato_frame_offset
	
	if growth_sate == Data_types.GrowthStates.Maturity:
